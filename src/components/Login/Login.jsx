        ...
        {success && (
          <div className="w-full max-w-xs">
            <section onSubmit={handleSubmit} className="bg-turq-gradient-to-b border-2 border-turquiose shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
              ...
              <h1 className="text-lg text-offWhite font-dm-sans-bold text-center mb-4">Logged in sucessfully.</h1>
              
              <p>
                <a href="#" className="text-offWhite hover:text-[#287d78] text-center">Dashboard</a>
              </p>
            </section>
          </div>
        )}
