...
function NavBar({ logOut }) {
  return (
    ...
    <div className="flex lg:gap-2 text-md">
      <button className="w-[100px] bg-darkGray hover:bg-turquiose text-white hover:scale-105 ease-in duration-200 font-dm-sans py-2 px-4 rounded"> Location</button>
